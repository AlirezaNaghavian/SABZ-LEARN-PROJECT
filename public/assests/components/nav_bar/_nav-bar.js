...
<section class="  header-sec flex items-center justify-between px-9 md:px-16 lg:px-5 xl:px-12 h-[88px] md:h-32 dark:border-b dark:border-b-gray-700 mx-auto max-w-[1920px]">
<!-- bars-mobile-icon -->
